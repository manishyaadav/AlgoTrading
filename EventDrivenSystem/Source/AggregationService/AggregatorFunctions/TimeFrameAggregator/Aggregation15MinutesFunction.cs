...
{
    public class Aggregation15MinutesFunction
    {
        private readonly ILogger<Aggregation15MinutesFunction> _logger;
        ...
        [Function("StreamAggregator15MFunction")]
        public async Task Run(
               [KafkaTrigger("%KAFKA_BROKER_URL%",
                  "live-aggregation-ohlc-5min-topic",
                  AuthenticationMode = BrokerAuthenticationMode.Plain,
                  ConsumerGroup = "live-aggregator-15min-consumer")] string eventDataJson, FunctionContext context)
        {
