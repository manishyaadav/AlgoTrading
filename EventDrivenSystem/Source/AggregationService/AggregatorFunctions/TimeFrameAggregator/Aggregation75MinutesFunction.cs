...
{
    public class Aggregation75MinutesFunction
    {
        private readonly ILogger<Aggregation75MinutesFunction> _logger;
        ...
        [Function("StreamAggregator75MFunction")]
        public async Task Run(
               [KafkaTrigger("%KAFKA_BROKER_URL%",
                  "live-aggregation-ohlc-15min-topic",
                  AuthenticationMode = BrokerAuthenticationMode.Plain,
                  ConsumerGroup = "live-aggregator-75min-consumer")] string eventDataJson, FunctionContext context)
        {
