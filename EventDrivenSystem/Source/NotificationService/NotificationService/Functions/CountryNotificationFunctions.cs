...
{
    public class CountryNotificationFunctions
    {
        private readonly ILogger<CountryNotificationFunctions> _logger;
        private readonly IProducer<string, string> _producer;
        private readonly string _signalRServerUrl;
        private readonly RedisHelper _redisHelper;

        public CountryNotificationFunctions(ILogger<CountryNotificationFunctions> logger, 
        ...
        [Function("CountryNotificationFunction")]
        public async Task Run(
                    [KafkaTrigger("%KAFKA_BROKER_URL%",
                        "live-country-workflow-topic",
                        AuthenticationMode = BrokerAuthenticationMode.Plain,
                        ConsumerGroup = "live-country-notification-consumer")] string eventDataJson, 
                    FunctionContext context)
        {
            _logger.LogInformation("Kafka triggered function: Country Notification Starting");
